        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <form class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <Input id="name" placeholder="Mario Rossi" class="bg-gray-50 border-gray-200 focus-visible:ring-[#ED8900] h-12" />
                </div>
                <div class="space-y-2">
                    <Label for="email" class="text-[#4B4846]">Email</Label>
                    <Input id="email" type="email" placeholder="mario@email.com" class="bg-gray-50 border-gray-200 focus-visible:ring-[#ED8900] h-12" />
                </div>
                </div>
                
                <div class="space-y-2">
                <Label for="phone" class="text-[#4B4846]">Telefono (opzionale)</Label>
                <Input id="phone" type="tel" placeholder="+39 333 1234567" class="bg-gray-50 border-gray-200 focus-visible:ring-[#ED8900] h-12" />
                </div>

                <div class="space-y-2">
                <Label for="message" class="text-[#4B4846]">Messaggio</Label>
                <Textarea rows="6" id="message" placeholder="Salve, vorrei ricevere informazioni su..." class="bg-gray-50 border-gray-200 focus-visible:ring-[#ED8900]" />
                </div>

                <div class="text-center pt-4">
                    <Button class="w-full md:w-auto px-12 bg-[#ED8900] hover:bg-orange-600 text-white font-bold py-6 text-lg shadow-lg shadow-orange-500/20">
                    Invia Richiesta
                    </Button>
                </div>
            </form>
